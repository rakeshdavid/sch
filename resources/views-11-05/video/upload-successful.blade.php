...
@section('content')
	<section class="video-download-wrap upload-content">
         <div class="process-steps">
            <a href="#" class="back-arrow"><img src="img/back-arrow.png" alt="" class="img-fluid"></a>
            <a href="#" class="close-icon"><img src="img/close.png" alt="" class="img-fluid"></a>
        ...
        <div class="video-content ">
            <div class="container">
                <h2>Upload Successful! {{$video_id}}</h2>
                ...
                <div class="youtube-link">
                    ...
                    <div class="coach-select text-center">
                      ...
                      <a href="#" class="go-back">Go back and upload again</a>
                    </div>
                </div>
