...
class YouTubeDownloaderController extends Controller
{
   ...
   function media_info($url)
   {
    ...
    //    $data = $yt->getDownloadLinks($url);
       ...
       try {
            ...
            if ($downloadOptions->getAllFormats()) {
                $video['links'][]['url'] = $downloadOptions->getFirstCombinedFormat()->url;
    ...
    //    echo '<pre>';print_r($downloadOptions->getInfo());
    //    echo $videoInfo->getTitle();
    //    echo 'dfd';exit;
    ...
    //    $video["duration"] = $this->format_seconds($json["videoDetails"]["lengthSeconds"]);
    ...
    //         //    if (empty($file_size)) {
    //             //    \Log::info('File size is empty for this youtube video: '.$url."\n Downloadable url: ".$link["url"]);
    //             //    $file_size = get_file_size($link["url"], $this->enable_proxies);
    //         //    }
    ...
    //        }
    //    }
    //   //  usort($video["links"], array($this,'sort_by_quality'));
    //    return $video;
   }
