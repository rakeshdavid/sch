...
class Review extends Model
{
    ...
    public static function getByVideoIdFull($id){
        $result = DB::table('reviews as r')
                ...
                ->select("r.*", "v.name as video_name", "v.level as video_level", "v.genres as video_genres", "v.description as video_description", "v.url as video_url", "u.id as user_id", "u.first_name as user_first_name", "u.last_name as user_last_name", "u.avatar as user_avatar")
                ->where('r.video_id', '=', $id)
                ->orderBy('r.id', 'desc')
                ->first();
        return $result;
    ...
    public static function getByUserIdFull($id, $user_id){
        $result = DB::table('reviews as r')
                ->join('videos as v', 'v.id', '=', 'r.video_id')
                ->join('users as u', 'v.user_id', '=', 'u.id')
                ->select("r.*", "v.name as video_name", "v.level as video_level", "v.genres as video_genres", "v.created_at as video_created_at", "v.description as video_description", "v.url as video_url", "u.id as user_id", "u.first_name as user_first_name", "u.last_name as user_last_name", "u.avatar as user_avatar")
                ->where('r.video_id', '=', $id)
