                    ...
                    <div class="layout two-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <div class="column" style="Float: left;max-width: 320px;min-width: 300px; width: 320px;width: calc(12300px - 2000%);text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;"><span style="color:#8e959c"><strong>Payment received</strong></span></h3>
                                </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <p style="Margin-top: 0;Margin-bottom: 0;">
                                    <strong style="transition: opacity 0.1s ease-in;color: #8e959c;"> <br>
                                        ...
                                        Your payment has been accepted by Stripe.<br><br>
                                        Transaction Date: {{$date}}<br>
                                        Transaction Amount: ${{$amount}}<br>
                                        Credit Card Type: {{$card_type}}<br>
                                        Credit Card Ending In: {{$card_last4}}
                                        <br>
                                        <br>
                                        Allow 3 to 5 Business days for {{$agency_name}} to read through your written description,
                                        view your video and finally, fill out a full audio and written review of your video submission.
                                        This process takes some time, as they work hard to give each submission a personalized look and review.
                                        <br>
                                        <br>
                                        We also want to remind you as we state in our <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: blue;" href="http://www.showcasehub.com/terms.html">http://www.showcasehub.com/terms.html</a>
                                        this review only pertains to this particular video submitted.  This review is not a judgment of you as an all around performer.
                                        We appreciate your payment and thank you for choosing Showcase Hub, where we supply you with today’s world-renowned performing art’s professionals.
                                        <br>
                                        <br>
                                        Sincerely,<br>
                                        Showcase Hub
