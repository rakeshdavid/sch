...
return [
    ...
    */
    ...
    'admin_url' => 'https://'.env('ADMIN_PLATFORM','admin').'.'.env('APP_DOMAIN'),
    'user_url' => 'https://'.env('USER_PLATFORM','platform').'.'.env('APP_DOMAIN'),
    'coaches_url' => 'https://'.env('COACH_PLATFORM','coaches').'.'.env('APP_DOMAIN'),
    'agency_url' => 'https://'.env('AGENCY_PLATFORM','agency').'.'.env('APP_DOMAIN'),
    ...
    */
    ...
    'aliases' => [
        ...
        'ApplePayHelper' => App\Http\Helpers\ApplePayHelper::class,
    ],
