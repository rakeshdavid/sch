        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="login-page text-center animated fadeIn delay-2000">
                    <div class="row">
                        <div class="m-t-50 col-xs-offset-2 col-xs-8 col-sm-offset-3 col-sm-6 col-md-offset-3 col-md-6 col-lg-offset-4 col-lg-4">
                            <form name="form" novalidate class="form-bg-cr" role="form" method="POST" action="{{ url('/password/reset') }}">
                                <h1 class="m-t-20">Reset password</h1>
                                <h4>Please enter your email address and new password</h4>
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    @if (session('status'))
                                        <div class="alert alert-success-outline animated fadeIn" role="alert">
                                            ...
                                            </button> <strong>success!</strong> {{ session('status') }}</div>
                                    @endif
                                    <div class="col-xs-12">
                                        <div class="form-group floating-labels {{ $errors->has('email') ? ' has-error' : '' }}">
                                            <label for="email">Email</label>
                                            <input style="color: #d9d9d9 !important;" id="email" autofocus autocomplete="off"
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group floating-labels {{ $errors->has('password') ? ' has-error' : '' }}">
                                            ...
                                            <input id="password" autofocus style="color: #d9d9d9 !important;" autocomplete="off"
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group floating-labels {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                            ...
                                            <input id="password_confirmation" autofocus autocomplete="off" style="color: #d9d9d9 !important;"
                                                   type="password" name="password_confirmation">
                                            <p class="error-block">{{ $errors->has('password_confirmation') ? $errors->first('password_confirmation') : '' }}</p>
                                        </div>
                                    </div>
                                </div>

                                <div class="row buttons m-b-0">
