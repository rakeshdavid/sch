...
@endsection
@section('css')
<link rel="stylesheet" type="text/css" href="/platform/css/newcss.css?v=@php echo date('Y-m-d-h-i-s');@endphp">
@endsection
                    ...
                    <div class="slider-wrapper" style="display: none;">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item carousel-item-1 active" style="background: url(/platform/img/black-man1.jpg);" >
                                ...
                                <div class="carousel-item carousel-item-2" style="background: url(/platform/img/slide01.jpg);" >
                                    <div class="carousel-caption record-caption">
                                        ...
                                        <p>Submit your dance reel, rehearsal video or studio work.</p>
                                    </div>
                                </div>
                                <div class="carousel-item carousel-item-3" style="background: url(/platform/img/slide2.jpg);" >
                                ...
                                <div class="carousel-item carousel-item-4" style="background: url(/platform/img/slide3.jpg);" >
                        ...
                        <div class="outer-box">
                            ...
                            <div class="inner-form">
                                    <form class="login-form" id="login-form" method="POST" action="{{ url('/login') }}">
                                      {!! csrf_field() !!}
                                        <h3>LOG IN</h3>
                                        <!-- <div class="facebook-btn"><a href="{{url('auth/facebook')}}"><span><i class="fab fa-facebook-square"></i></span>Continue With Facebook</a></div>
