            ...
            <table id="coaches-table" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($participants as $participant)
                        <tr>
                            ...
                            <td>{{$participant->audition->audition_name}}</td>
                            <td>
                            ...
                            <td>
                                ...
                                <div id="ex-video-{{$participant->id}}" class="modal">
                                    <p>Video</p>
                                    <video class="video-pause" id="auditions-video-{{$participant->id}}" width="100%" height="300" controls="">
                                        <source src="/uploads/auditions/{{$participant->video_link}}">
                            ...
                            <td>
                                ...
                                @if($participant->auditionreviewnew =='')
