...
class UpdateCoachRequest extends Request
{
    /**
    ...
    public function rules()
    {
        $rules =  [
            ...
            'coachs_site'           => 'max:255',
            'vacation_start'        => 'date_format:"Y-m-d"|required_with:vacation_end',
            'vacation_end'          => 'date_format:"Y-m-d"|after:vacation_start|required_with:vacation_start',
