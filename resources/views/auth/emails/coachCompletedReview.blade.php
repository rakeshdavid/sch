                    ...
                    <div class="layout two-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <div class="column" style="Float: left;max-width: 320px;min-width: 300px; width: 320px;width: calc(12300px - 2000%);text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;"><span style="color:#8e959c"><strong>{{ucfirst($reviewer)}} completed a review </strong></span></h3>
                                </div>
                ...
                <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #fff;">
                        ...
                        <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <p style="Margin-top: 0;Margin-bottom: 0;"><strong>Dear {{$user_name}},</strong></p>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <p style="Margin-top: 0;Margin-bottom: 0;">
                                    <strong style="transition: opacity 0.1s ease-in;color: #8e959c;"> <br>
                                        {{$coach_name}} has completed your review.
                                        Sign into your profile, go to my videos and click on the show review button.
                                        Hit the play button underneath the video, hear what {{$coach_name}} had to say, read through the review and look over your scorecard.
                                        <br>
                                        <br>
                                        We hope that you are satisfied with your review and that {{$coach_name}} was able to help.
                                        <br>
                                        <br>
                                        We encourage any feedback of your experience and of {{$coach_name}} submitted review.
                                        Submit your feedback to <a target="_top" href="mailto:support@showcasehub.com">support@showcasehub.com</a>
                                        <br>
                                        <br>
                                        <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: blue;" href="http://www.showcasehub.com/rate-your-coach.html">Rate your {{$reviewer}}</a>
                                        <br>
                                        <br>
                                        Again, as a reminder, as we state in our <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: blue;" href="http://www.showcasehub.com/terms.html"> http://www.showcasehub.com/terms.html</a>
                                        this review only pertains to this particular video submitted.
                                        This review is not a judgment of you as an all around performer(s); it pertains only to this specific performance.
                                        <br>
                                        <br>
                                        Sincerely,<br>
                                        Showcase Hub
