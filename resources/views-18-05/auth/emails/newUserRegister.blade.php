                ...
                <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #fff;">
                        ...
                        <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <p style="Margin-top: 0;Margin-bottom: 0;"><strong>Dear {{$first_name}},</strong></p>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <p style="Margin-top: 0;Margin-bottom: 0;">
                                    <strong style="transition: opacity 0.1s ease-in;color: #8e959c;"> <br>
                                        You now have access to our entire list of world-renowned coaches in the performing art’s industry.<br>
                                        Scroll through each profile to find the perfect match, you can search by Genre, Class level or simply by name.<br>
                                        Our goal is to supply a user-friendly platform, where you can connect directly to an industry professional.<br>
                                        You’ll receive a personalized audio and written review of your video submission from the coach of your choice.<br>
                                        If you’re getting ready for an up coming audition, solo / group performance or looking to take your talent to <br>
                                        the next level, submit a video today.<br>
                                        <br>
                                        Instructions<br>
                                        Step 1 – Browse through our list of coaches<br>
                                        Step 2 – After you have selected your coach, pick from one of the two packages displayed on their profile page:Summary / Detailed<br>
                                        Step 3 – Simply upload your video and fill out our submission review form.<br>
                                        <br>
                                        SUMMARY<br>
                                        PACKAGE<br>
                                        <br>
                                        THIS PACKAGE INCLUDES:<br>
                                        * Audio review of your performance<br>
                                        * Written summary of feedback<br>
                                        * Summary performance review scorecard<br>
                                        * Level placement<br>
                                        <br>
                                        DETAILED<br>
                                        PACKAGE<br>
                                        ...
                                        * Written summary of feedback<br>
                                        * Level placement<br>
                                        * Detailed performance review scorecard<br>
                                        * Answers to your 3 questions<br>
                                        <br>
                                        Please be as detailed as possible when describing your video submission, this helps our coaches deliver a more personalized review.<br>
                                        The more information they have about you and your performance, the better they can assist you in achieving your goals.<br>
                                        <br>
                                        Sincerely,<br>
                                        Showcase Hub<br>
                                    </strong>
