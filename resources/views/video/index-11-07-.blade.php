                                ...
                                <div class="card">
                                    <div class="videos-box">
                                        ...
                                        @if(strpos($video->url, 'youtube') !== false)
                                            ...
                                            @endif
                                        @else
                                       <video id="all-video-{{$video->id}}" width="100%" height="300" controls >
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="firs-snow-content">
                                        ...
                                        @endphp
                                            ...
                                            @endif
                                        @else
                                        <video id="rating-video-{{$video->id}}" width="100%" height="300" controls >
                                            <source src="{{url('/') . config('video.user_video_path') . $video->url}}">
                                            Your browser does not support HTML5 video.
                                        </video>
                                            @if($video->thumbnail !='')
                                                <img class="video-thumb" data-videoid="rating-video-{{$video->id}}"  src="{{url('/') . config('video.thumbnail_path')}}{{$video->thumbnail}}" />
                                            @endif
                                        @endif
                                        </div>
                                        <h3>{{$video->name}}</h3>
                                    ...
                                    <div class="videos-box">
                                       @if(strpos($video->url, 'youtube') !== false)
                                        ...
                                        @endphp
                                            ...
                                            @endif
                                        @else
                                        <video id="waiting-review-{{$video->id}}" width="100%" height="300" controls >
                                            <source src="{{url('/') . config('video.user_video_path') . $video->url}}">
                                            Your browser does not support HTML5 video.
                                        </video>
                                            @if($video->thumbnail !='')
                                    ...
                                    <div class="videos-box">
                                       @if(strpos($video->url, 'youtube') !== false)
                                        ...
                                        @endphp
                                            ...
                                            @endif
                                        @else
                                        <video id="payment-video-{{$video->id}}" width="100%" height="300" controls >
                                            <source src="{{url('/') . config('video.user_video_path') . $video->url}}">
                                            Your browser does not support HTML5 video.
                                        </video>
                                            @if($video->thumbnail !='')
                                    ...
                                    <div class="videos-box">
                                       @if(strpos($video->url, 'youtube') !== false)
                                        ...
                                        @endphp
                                            ...
                                            @endif
                                        @else
                                        <video id="payment2-{{$video->id}}" width="100%" height="300" controls >
                                            <source src="{{url('/') . config('video.user_video_path') . $video->url}}">
                                            Your browser does not support HTML5 video.
                                        </video>
                                            @if($video->thumbnail !='')
                    ...
                    <div class="firs-snow-content">
                        <div class="videos-box">
                            @if(strpos($rating->url, 'youtube') !== false)
                                ...
                                @endif
                            @else
                           <video id="videorating-{{$rating->id}}" width="100%" height="300" controls >
                                <source src="{{url('/') . config('video.user_video_path') . $rating->url}}">
                                Your browser does not support HTML5 video.
                            </video>
                                @if($rating->thumbnail !='')
                                    <img class="video-thumb" data-videoid="videorating-{{$rating->id}}"  src="{{url('/') . config('video.thumbnail_path')}}{{$rating->thumbnail}}" />
                                @endif
                            @endif
                        </div>
                        <h3>{{$rating->name}}</h3>
