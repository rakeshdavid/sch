            ...
            <div class="col-xl-8 col-lg-12">
                <form action="/profile/{{$user->id}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="media-body">
                        <div class="info-box">
                            <a href="javascript:void(0)" class="user-name">
                                ...
                                <input type="text" name="first_name" class="form-control" placeholder="{{$user->first_name}} @if($user->first_name){{$user->first_name}}@endif" value="{{$user->first_name}} @if($user->last_name){{$user->last_name}}@endif">
                            ...
                            <div class="dance-style-list">
                                ...
                                <input type="text" value="{{$activity_genres}}" data-role="tagsinput" class="form-control" />
                            </div>
                        </div>
                    </div>
                 </div>
                    <a href="javascript:void(0)" class="description">
                         ...
                         <textarea class="form-control" >{{ strip_tags($user->about) }}
                         </textarea>
                           ...
                           <div class="icon-box"><img src="/assets/img/Phone.png" alt="" class="img-fluid"></div>
                            <div class="right-box">
                               <label>Phone Number</label>
                                <input type="number" value="{{$user->phone}}" class="form-control" placeholder="Add Number…" name="phone" autocomplete="off" />
                            </div>
                          </div>
                        <div class="form-group col-sm-6">
