        ...
        <div class="col-xs-12">
            ...
            <h4 class="m-b-20 m-t-20">Agency Data</h4>
             @if (Session::has('success'))
              ...
              @endif
            <form action="{{ url('agency')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group row {{ $errors->has('first_name') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="254" class="form-control {{ $errors->has('first_name') ? ' form-control-danger' : '' }}" name="first_name" autocomplete="off" value="{{ old('first_name') }}">
                ...
                <div class="form-group row {{ $errors->has('last_name') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="254" class="form-control {{ $errors->has('last_name') ? ' form-control-danger' : '' }}" name="last_name" autocomplete="off" value="{{ old('last_name') }}">
                ...
                <div class="form-group row {{ $errors->has('email') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="email" maxlength="254" class="form-control {{ $errors->has('email') ? ' form-control-danger' : '' }}" name="email" autocomplete="off" value="{{ old('email') }}">
                        @if($errors->has('email'))
                ...
                <div class="form-group row {{ $errors->has('location') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="test" maxlength="254" class="form-control {{ $errors->has('location') ? ' form-control-danger' : '' }}" name="location" autocomplete="off" value="{{ old('location') }}">
                ...
                <div class="form-group row {{ $errors->has('location_state') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="location_state" maxlength="254" class="form-control {{ $errors->has('location_state') ? ' form-control-danger' : '' }}" name="location_state" autocomplete="off" value="{{ old('location_state') }}">
