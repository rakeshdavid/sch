    ...
    $.fn.extend({
        floatingLabels: function(options) {
            ...
            if(options.hasError) {
                ...
                //$(this).parent('.form-group.floating-labels').addClass('has-error').addClass('has-focus');
                var errorMsg = options.staticError !== false ? options.staticError : options.errorBlock;
                $(this).parent('.form-group.floating-labels').find('.error-block').removeClass('hidden').text(errorMsg);
            }
