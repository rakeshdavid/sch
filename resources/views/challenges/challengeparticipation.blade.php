                ...
                <div class="col-md-9">
                    <div class="youtube-link">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-8">
                                ...
                                <div class="col-md-12 p-0 text-danger" id="response">
                            	</div>
                            </div>
                    ...
                    <div class="drag-file">
                        <div class="dropzone-content">
                            <form action="{{url('challenge/participation')}}/{{$challenge_id}}" method="post" class="dropzone" id="my-awesome-dropzone">
                        ...
                        <div class="skip-box">
                            ...
                            <a href="{{url('challenges')}}" class="skip">SKIP FOR NOW</a>
                        </div>
                    </div>
