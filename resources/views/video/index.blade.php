                                ...
                                <div class="card">
                                    ...
                                    @if($video->pay_status)
                                        ...
                                        @else
                                            ...
                                            @else
                                                <a href="@if($video->package_id == 2){{url('ask-question')}}@else{{url('payment')}}@endif/{{$video->id}}" class="btn btn-outline-danger" style="padding: 11px 10px;">Payment</a>
                                            @endif
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="firs-snow-content">
                                        ...
                                        <div class="updated"><p>Uploaded on  @php
                                        $v_data = new \Carbon\Carbon($video->created_at);
                                        echo $v_data->format("m.d.Y g:i A");
                                        @endphp</p></div>
                                        <ul class="nav" id="myTab" role="tablist">
                            ...
                            <div class="col-xl-4 col-md-6 audition-{{$video->audition_id}} pid-{{$video->id}}">
                                <div class="card">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h3>@if($video->audition){{$video->audition->audition_name}} @endif</h3>
                                            <p>Uploaded on  @php
                                            $v_data = new \Carbon\Carbon($video->created_at);
                                            echo $v_data->format("m.d.Y g:i A");
                                        @endphp</p>
                            ...
                            <div class="col-xl-4 col-md-6 challenge-{{$video->challenge_id}} pid-{{$video->id}}">
                                <div class="card">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h3>@if($video->challenges){{$video->challenges->challenges_name}}@endif</h3>
                                            <p>Uploaded on  @php
                                            $v_data = new \Carbon\Carbon($video->created_at);
                                            echo $v_data->format("m.d.Y g:i A");
                                        @endphp</p>
                    ...
                    <div class="firs-snow-content">
                        ...
                        <div class="updated">
                            @php
                                ...
                                echo 'Uploaded on ' . $v_data->format("m.d.Y g:i A");
                            @endphp
                            @php
